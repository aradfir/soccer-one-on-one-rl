...
class WorldModel(_message.Message):
    ...
    class HeliosHomePositionsEntry(_message.Message):
        ...
        key: int
        value: Vector2D
        def __init__(self, key: _Optional[int] = ..., value: _Optional[_Union[Vector2D, _Mapping]] = ...) -> None: ...
...
class State(_message.Message):
    ...
    def __init__(self, agent_type: _Optional[_Union[AgentType, str]] = ..., world_model: _Optional[_Union[WorldModel, _Mapping]] = ..., full_world_model: _Optional[_Union[WorldModel, _Mapping]] = ...) -> None: ...

class InitMessage(_message.Message):
    __slots__ = ("agent_type", "debug_mode")
    AGENT_TYPE_FIELD_NUMBER: _ClassVar[int]
    DEBUG_MODE_FIELD_NUMBER: _ClassVar[int]
    agent_type: AgentType
    debug_mode: bool
    def __init__(self, agent_type: _Optional[_Union[AgentType, str]] = ..., debug_mode: bool = ...) -> None: ...
...
class DoMoveBall(_message.Message):
    ...
    position: Vector2D
    velocity: Vector2D
    def __init__(self, position: _Optional[_Union[Vector2D, _Mapping]] = ..., velocity: _Optional[_Union[Vector2D, _Mapping]] = ...) -> None: ...
...
class DoMovePlayer(_message.Message):
    ...
    position: Vector2D
    body_direction: float
    def __init__(self, our_side: bool = ..., uniform_number: _Optional[int] = ..., position: _Optional[_Union[Vector2D, _Mapping]] = ..., body_direction: _Optional[float] = ...) -> None: ...
